"""
PRIME SCANNER PRO — Build Data Pipeline v12.0
...
GROUPS = {
    ...
    # ── US MARKET (Top stocks cerca de parámetros de inversión) ──
    "🇺🇸 US Market": [
        # Tech Leaders
        "AAPL","MSFT","GOOGL","AMZN","META","TSLA","ORCL","CRM",
        "ADBE","NOW","PANW","CRWD","SNOW","NET","DDOG",
        # Financials
        "JPM","V","MA","GS","MS","BLK","SCHW","AXP","C","BAC","WFC",
        "ICE","CME","SPGI","MCO",
        # Healthcare
        "UNH","LLY","JNJ","ABBV","MRK","PFE","TMO","ISRG",
        "VRTX","REGN","AMGN","GILD","MDT","SYK",
        # Energy & Defense
        "XOM","CVX","COP","SLB","RTX","GD","BA",
        "OXY","DVN","HAL","HES",
        # Infrastructure & Industrial
        "HON","MMM","CMI","PH","ITW","TT","EMR",
        # Consumer
        "COST","WMT","HD","LOW","NKE","SBUX","MCD","PG","KO","PEP",
    ],
}
...
def main():
    ...
    print(f"PRIME SCANNER PRO — Building data at {datetime.now()}")
    groups_data = {}
